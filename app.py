...
# Bagian Hasil Prediksi Data Realtime
st.subheader("Hasil Prediksi Data Realtime")

# Menambahkan gambar di sebelah tulisan Hasil Prediksi Data Realtime
col_img, col_text = st.columns([2, 5])  # Membuat dua kolom dengan proporsi 2:5

with col_img:
    st.image("logo.png", width=50)  # Menambahkan gambar dengan ukuran 500 piksel lebar

with col_text:
    st.write("**Data Sensor Realtime:**")
    # Mengatur style tabel untuk data sensor
    st.markdown("""
        <style>
        table { width: 100%; }
